...
public:
  void Insert_Node_At_Beginning(double value)
  ...
  void Remove_Node(double value) // Function To Remove Node
  {
...
public:
  void Insert_Node_At_Beginning(double value) // Function To Add Data In First
  {
